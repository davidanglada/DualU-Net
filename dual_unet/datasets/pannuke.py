...
def pannuke2coco(data_dir, fold, out_dir):
    """Converts the Pannuke dataset to COCO format.
    Args:
...
# config_path = "/home/usuaris/imatge/david.anglada/PhD/tesi/dual_unet/config.yaml"
# import yaml
...
# dataset = build_pannuke_dataset(config, split='train')
